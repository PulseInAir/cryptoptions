      ...
      <div className="container py-12 grid gap-8 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-bold text-lg">Crypt<span className="text-gradient">Options</span></span>
          </div>
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">CryptOptions is an educational paper-trading platform. Market data via Delta Exchange India public APIs. No real orders are placed.</p>
        </div>
      </div>
      <div className="border-t border-border py-6 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} CryptOptions. Built for traders who think in payoffs.
      </div>
    </footer>
  );
}
